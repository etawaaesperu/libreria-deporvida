...
export function AdminPedidosMenuView() {
  ...
  return (
    <>
      ...
      <div className="class-grid">
        {CATEGORIES.map(c => (
          <div key={c} className="class-card" onClick={() => navigate('admin-registrar-pedido', { class: c })}>
      ...
      <div className="class-grid">
        {CATEGORIES.map(c => (
          <div key={c} className="class-card" onClick={() => navigate('admin-view-pedidos', { class: c })}>
